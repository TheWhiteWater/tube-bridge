...
**YouTube MCP server for AI agents. 16 tools: search, discovery, transcripts, comments, semantic corpus. 13 zero-setup, 3 with optional Data API v3 key.**

## Quick Nav

| Document | Purpose |
|----------|---------|
| [PROJECT_VISION.md](../PROJECT_VISION.md) | Product boundaries, tool baseline, open-core scope |
...
| [06_ADR_RULES.md](constitution/06_ADR_RULES.md) | How decisions get made |
| [MVP_SCOPE.md](planning/MVP_SCOPE.md) | Implementation baseline shipped in source |
| [WORK_BREAKDOWN.md](planning/WORK_BREAKDOWN.md) | Blocks A–H: decomposition and dependencies |
| [PUBLICATION_READINESS.md](planning/PUBLICATION_READINESS.md) | Four-surface readiness checklist with gates |
| [OPEN_QUESTIONS.md](planning/OPEN_QUESTIONS.md) | Resolved questions and blocking decisions |
| [ADR-001](adr/001-demo-api-quota-and-product-boundary.md) | Demo API access, quota boundary, product separation |
...
- **Architecture direction:** ADR-001 accepted (2026-08-08) — demo access, quota boundary, product separation. Not launch approval.
- **Active WorkItem:** WI-00027 (documentation synchronization)
- **Active TME direction:** DIR-004-publication-productization
- **Full publication:** Not accepted. Readiness checklist in `docs/planning/PUBLICATION_READINESS.md`. Four launch surfaces: core library and controlled demo target this cycle; extension and Grabbit do not block.
