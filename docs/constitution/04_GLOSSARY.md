...
| **publication gate** | Per-surface P0/P1 checks in `docs/planning/PUBLICATION_READINESS.md`. The self-hosted core gate has passed; the disposable-demo gate remains separate. |
